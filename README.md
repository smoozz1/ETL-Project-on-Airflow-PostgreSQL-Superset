...
- Apache Superset
- инициализатор Superset 
- redis для кеширования данных из Superset

Между собой контейнеры связаны сетью `my-network`. Для метаданных Airflow и Superset созданы соответственные базы данных в PostgreSQL.  
Для веб интерфейсов Airflow и Superset назначены локальные порты :8000 и :8088.

### DAG (ETL pipeline)  

DAG файл - `./airflow/dags/hh_scraper.py`. 
...
перевод в ₽ с учетом курса валют ЦБ РФ (если изначально не в рублях)
...
## P.S.
При желании, можно адаптировать под другие професии, поправив категорирование и ключевые навыки
